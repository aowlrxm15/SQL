...
insert into `Doctors` values ('D103101', '장보고', '1979-07-28', 'M', '103', '과장', '010-3101-1979', 'jangbo@bw.com');
...
insert into `Treatmenets` values ('1021001', 'D102101', 'P102101', '감기, 몸살', now());
insert into `Treatmenets` values ('1031002', 'D103101', 'P103101', '교통사고 외상', now());
insert into `Treatmenets` values ('1021003', 'D102104', 'P102102', '위염, 장염', now());
insert into `Treatmenets` values ('1041004', 'D104101', 'P104101', '피부 트러블', now());
insert into `Treatmenets` values ('1051005', 'D105101', 'P105101', '코막힘 및 비염', now());
insert into `Treatmenets` values ('1031006', 'D103101', 'P103102', '목 디스크', now());
insert into `Treatmenets` values ('1041007', 'D104101', 'P104102', '여드름', now());
insert into `Treatmenets` values ('1081008', 'D108101', 'P108101', '오른쪽 발목 뼈 골절', now());
insert into `Treatmenets` values ('1021009', 'D102104', 'P102103', '소화불량', now());
insert into `Treatmenets` values ('1071010', 'D107104', 'P107101', '가슴 통증', now());
insert into `Treatmenets` values ('1051011', 'D105101', 'P105102', '귀 이명', now());
insert into `Treatmenets` values ('1041012', 'D104101', 'P104103', '팔목 화상', now());
