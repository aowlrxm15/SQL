...
insert into `Professors` (`proNo`, `depNo`, `proName`, `proJumin`, `proHp`, `proEmail`, `proAddr`) values ('p23102', '23', '선덕여왕', '830614-1234567', '010-4101-1984', 'gueen@hg.ac.kr', '대구');
...
insert into `Professors` (`proNo`, `depNo`, `proName`, `proJumin`, `proHp`, `proEmail`, `proAddr`) values ('p31104', '31', '신사임당', '711127-1234567', '010-6101-1972', 'sinsa@hg.ac.kr', '부산');
...
insert into `Professors` (`proNo`, `depNo`, `proName`, `proJumin`, `proHp`, `proEmail`, `proAddr`) values ('p42103', '42', '송상현', '760313-1234567', '010-8101-1977', 'ssh@hg.ac.kr', '광주');

insert into `students` (`stdNo`, `depNo`, `proNo`, `stdName`, `stdJumin`, `stdHp`, `stdEmail`, `stdAddr`) values ('20101001', '10', 'p10101', '정우성', '760121-1234567', '010-1101-7601', null, '서울');
insert into `students` (`stdNo`, `depNo`, `proNo`, `stdName`, `stdJumin`, `stdHp`, `stdEmail`, `stdAddr`) values ('20101002', '10', 'p10101', '이정재', '750611-1234567', '010-1102-7506', null, '서울');
...
insert into `students` (`stdNo`, `depNo`, `proNo`, `stdName`, `stdJumin`, `stdHp`, `stdEmail`, `stdAddr`) values ('22311014', '31', 'p31104', '유재석', '721128-1234567', '010-6101-7211', null, '부산');
insert into `students` (`stdNo`, `depNo`, `proNo`, `stdName`, `stdJumin`, `stdHp`, `stdEmail`, `stdAddr`) values ('22401001', '40', 'p40101', '강호동', '920907-1234567', '010-7103-9209', null, '부산');
